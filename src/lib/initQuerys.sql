...
WITH newBookingId AS (
INSERT INTO booking
    VALUES ('${mail}', $ {price}, '[${from},${to}]', $ {duration}, $ {homeDelivery}, $ {pickupDelivery})
    RETURNING
      id;
...
INSERT INTO BookingOrder
  VALUES (selectedbike, newBookingId, 'pedalModelHola', FALSE);


/***/
WITH SERIALS AS (
  SELECT DISTINCT ON (BIKESIZE,
    MODELID)
    BIKESN
  FROM
    BIKE
